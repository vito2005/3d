...
const colors = {
  gridColor: new THREE.Color("#e6e6e6"),
  white: new THREE.Color("#ffffff"),
  darkColor: new THREE.Color("#005CDC"),
  lightColor: new THREE.Color("#80AEEE"),
  hoverColor: new THREE.Color("#DEE6F6"),
...
export default function Blocks3D({
  ...
  useEffect(() => {
    ...
    const cameraPosition = new THREE.Vector3(0.0, 6.0, 14.0);
    ...
    const pixelateShader = {
      uniforms: {
        ...
        hoverColor: { value: colors.hoverColor },
      ...
      fragmentShader: `
        ...
        bool isInsideCoin(vec2 canvasUv) {
          return true;
        }
        ...
        void main() {
          ...
          bool insideCoin = isInsideCoin(canvasUv);
          ...
          if (isWhite) {
            ...
            vec4 hoveredWhite = insideCoin
              ? applyWhiteHover(col, fc, cell, cellTopLeft, blockSize, cellUv, lightColor)
              : col;
          ...
          vec4 shaded = insideCoin
            ? applyHover(col, fc, cell, cellTopLeft, blockSize, cellUv, hoverColor)
            : col;
          gl_FragColor = shaded;
        }
      `,
    ...
    if (modelUrl) {
      gltfLoader.load(modelUrl, (gltf: any) => {
        ...
        // Смещаем объект вверх для центрирования на экране
...
const tweakSceneMaterials = (root: THREE.Object3D) => {
  ...
  root.traverse((obj: THREE.Object3D) => {
    ...
    materials.forEach((mat: any) => {
      ...
      if ((obj as any).name.includes("light")) {
